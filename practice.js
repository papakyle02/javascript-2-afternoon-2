...
var looper = family => {
  return family.forEach(e => alert(e))
}
...
var divider = nums => {
  ...
  var newArray = []
  newArray.unshift(oddsArray);
  newArray.unshift(evensArray);
  return newArray
}
...
// var finder = arr => {
//   var randomValueIndex = arr.indexOf(getRandomArbitrary())
//   return(
//     randomValueIndex === -1
//   ? false
//   : true
...
var removeItem = (myGroceryList, itemToRemove) => {
  ...
  return(myGroceryList && itemToRemove
  ? (itemIndex !== -1
    ? myGroceryList.splice(itemIndex, 1) && myGroceryList
    : myGroceryList
    )
  : []
  )
